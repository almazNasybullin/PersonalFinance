...
public class Account extends Common {
    ...
    public void setAmountFromTransactionsAndTransfers(List<Transaction> transactions, List<Transfer> transfers) {
        ...
        for (Transaction transaction: transactions){
            if (transaction.getAccount().equals(this)) this.amount += transaction.getAmount();
        }

        for (Transfer transfer: transfers){
            if (transfer.getFromAccount().equals(this)) this.amount -= transfer.getFromAmount();
            if (transfer.getToAccount().equals(this)) this.amount += transfer.getToAmount();
        }
    }
    ...
    public void postEdit(SaveData sd) {
        for (Transaction t: sd.getTransactions()) if (t.getAccount().equals(sd.getOldCommon())) t.setAccount(this);
